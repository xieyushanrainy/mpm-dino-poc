...
def main(args):
    ...
    if matrix.exists():
        ...
        if prior["arguments"] != provenance["arguments"]:
            raise ValueError("refusing to mix changed Gate-1E arguments")
        if (
    ...
    for seed in args.seeds:
        ...
        train_v42_gate1d(
            ...
            max_batches=args.max_batches, angular_dynamics=True,
        )
...
if __name__ == "__main__":
    ...
    parser.add_argument("--runs", default="v42/runs/gate1e_seed42_456")
