...
from mpm_dino_v4.v42_oracle import train_event_normalized_variant
...
def main(args):
    ...
    config = {
        "experiment": "v42_event_normalized_temporal_control",
        "analysis": "focused_two_arm_diagnostic_not_a_gate",
    ...
    if matrix.exists():
        ...
        for key in (
            ...
            "variants", "training_population", "training_frames", "objective",
        ):
    ...
    for variant in VARIANTS:
        for seed in args.seeds:
            ...
            if (output / "RUN_COMPLETE.json").exists():
                ...
                continue
            train_event_normalized_variant(
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Soft event-frame amplitude-normalized temporal diagnostic"
    )
    ...
    parser.add_argument(
        "--runs", default="v42/runs/event_normalized_temporal_seed42_456",
    )
